...
const Header = () => {
  ...
  let items = [
        ...
        return (
          <span className="inline-flex align-items-center gap-1 px-2 py-2">
            ...
            <span className="font-medium text-xl font-semibold">
              EMPRESA <span className="text-primary">RIGA</span>
            </span>
          </span>
        );
      },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          icon: "pi pi-user",
          template: itemRenderer,
          command: () => navigate("/persona"),
        },
        {
          label: "Empresas",
          icon: "pi pi-building",
          template: itemRenderer,
          command: () => navigate("/empresa"),
        },
        {
          label: "Ventas",
          icon: "pi pi-dollar",
          template: itemRenderer,
          command: () => navigate("/venta"),
        },
        {
          label: "Productos",
          icon: "pi pi-shopping-cart",
          template: itemRenderer,
          command: () => navigate("/producto"),
        },
      ],
    },
    {
    ...
    {
      command: () => {
        // Acción para mostrar información adicional o perfil de usuario
      },
